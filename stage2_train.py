...
def trainer_synapse(model):
    ...
    pos_data_path = r"E:\dataset\ultrasound_video_audio\DATA\dataset\train_dataset.csv" #正样本
...
def test_model(model):
    ...
    data_path = r"E:\dataset\ultrasound_video_audio\DATA\dataset\test_dataset_ldxTest.csv" #负样本
